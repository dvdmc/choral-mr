...
static const std::vector<std::vector<uint8_t>> generateColorMap(int numLabels) {
  ...
  const std::vector<std::vector<uint8_t>> genericMap = {
      {100, 100, 100}, {200, 200, 200}, {183, 135, 65}, {40, 40, 40},    {251, 171, 243},
      {76, 122, 210},  {200, 200, 3},   {120, 120, 80}, {200, 140, 140}, {204, 5, 255},
      {100, 235, 235}, {4, 250, 7},     {224, 5, 255},  {235, 255, 7},   {150, 5, 61},
      ...
      {0, 224, 255},   {112, 224, 255}, {70, 184, 160}, {163, 0, 255},   {153, 0, 255},
      {71, 255, 0},    {255, 0, 163},   {255, 204, 0},  {255, 0, 143},   {0, 255, 235},
      {133, 255, 0},   {255, 0, 235},   {245, 0, 255},  {255, 0, 122},   {255, 245, 0},
      {10, 190, 212},  {214, 255, 0},   {0, 204, 255},  {20, 0, 255},    {255, 255, 0},
