...
bool Bloomxai::ReadPointsFromPCD(const std::string& filepath, std::vector<Eigen::Vector3d>& points) {
  return ReadPointsFromPCD_Impl(filepath, points);
}

bool Bloomxai::ReadPointsFromPCD(const std::string& filepath, std::vector<Bonxai::Point3D>& points) {
  return ReadPointsFromPCD_Impl(filepath, points);
}
...
void Bloomxai::WritePointsFromPCD(
    const std::string& filepath, const std::vector<Eigen::Vector3d>& points) {
  WritePointsFromPCD_Impl(filepath, points);
}

void Bloomxai::WritePointsFromPCD(const std::string& filepath, const std::vector<Point3D>& points) {
  WritePointsFromPCD_Impl(filepath, points);
}

void Bloomxai::WritePointsFromPCD(const std::string& filepath, const std::vector<CoordT>& points) {
  WritePointsFromPCD_Impl(filepath, points);
}
