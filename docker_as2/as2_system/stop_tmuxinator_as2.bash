...
# Get drone namespaces from command-line argument if not provided, use drone1 and drone2 as default
if [ -z "$1" ]; then
    usage
    echo "No drone namespaces provided. Using default: drone1,drone2"
    drones_namespace_comma="drone1,drone2"
else
